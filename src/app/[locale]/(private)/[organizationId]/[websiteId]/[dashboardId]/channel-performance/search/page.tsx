...
export default async function SearchStatisticsPage({
  params,
  ...
  const [t, channelPerformanceDeepDive, channelPerformanceDeepDiveActivityDetails] = await Promise.all([
    getTranslations(),
    fetchChannelPerformanceDeepDiveOverview(params.dashboardId, ChannelFiltersDashboardEnum.Search, timeframe),
    fetchChannelPerformanceDeepDiveActivityDetails(
      params.dashboardId,
      ChannelFiltersDashboardEnum.Search,
      timeframe,
  ...
  // const [filter, setFilter] = useState<DetailPageFilterType | null>(null);
  ...
  return (
    <>
      <BaseCard
        ...
        headerProps={{
          title: t('general.channels.search')
